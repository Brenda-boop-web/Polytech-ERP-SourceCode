...
Report 52002 "Loan Appraisal Draft"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Company Information"; "Company Information")
        {
            ...
            dataitem("Loans Register"; "Loans Register")
            {
                ...
                column(ShareCapitalDue_LoansRegister; "Loans Register"."Shares Capital Due")
                {
                }
                ...
                column(CAPTION_TOP_UP_GENERAL; CAPTION_TOP_UP_GENERAL)
                {
                }
