...
Table 51001 "Payments Header"
{
    fields
    {
        ...
        {
            CalcFormula = sum("Payment Line New"."NetAmount LCY" where("Document No" = field("No.")));
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = sum("Payment Line New"."Retention  Amount" where("Document No" = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = sum("Payment Line New"."Refund Charge" where("Document No" = field("No.")));
            FieldClass = FlowField;
        }
