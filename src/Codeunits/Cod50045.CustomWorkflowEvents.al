codeunit 50045 "Custom Workflow Events"
{
    ...
    begin
        ...
        //-------------------------------------------End Approval Events-------------------------------------------------------------
        // //BOSA Transfers
        // WFHandler.AddEventToLibrary(RunWorkflowOnSendInternalTransfersForApprovalCode,
        //                     Database::"sacco Transfers", 'Approval of Sacco Transfer is Requested.', 0, false);
        // WFHandler.AddEventToLibrary(RunWorkflowOnCancelInternalTransfersApprovalRequestCode,
        ...
        //Funds Transfer
        WFHandler.AddEventToLibrary(RunWorkflowOnSendFundsTransferForApprovalCode,
                            Database::"Funds Transfer Header", 'Approval of Funds Transfer is Requested.', 0, false);
        WFHandler.AddEventToLibrary(RunWorkflowOnCancelFundsTransferApprovalRequestCode,
                                    Database::"Funds Transfer Header", 'An Approval request for Funds Transfer is canceled.', 0, false);
        //-------------------------------------------------------------------------
    ...
    procedure RunWorkflowOnCancelPaymentVoucherApprovalRequest(var PaymentVoucher: Record "Payments Header")
    begin
    ...
    //---------------------------------------------------------------------------------
    //9-2)Funds Transfer
    procedure RunWorkflowOnSendFundsTransferForApprovalCode(): Code[128]//
    begin
        exit(UpperCase('RunWorkflowOnSendFundsTransferForApproval'));
    end;


    procedure RunWorkflowOnCancelFundsTransferApprovalRequestCode(): Code[128]
    begin
        exit(UpperCase('RunWorkflowOnCancelFundsTransferApprovalRequest'));
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::SurestepApprovalsCodeUnit, 'FnOnSendFundsTransferForApproval', '', false, false)]

    procedure RunWorkflowOnSendFundsTransferForApproval(var FundsTransfer: Record "Funds Transfer Header")
    begin
        WorkflowManagement.HandleEvent(RunWorkflowOnSendFundsTransferForApprovalCode, FundsTransfer);
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::SurestepApprovalsCodeUnit, 'FnOnCancelFundsTransferApprovalRequest', '', false, false)]

    procedure RunWorkflowOnCancelFundsTransferApprovalRequest(var FundsTransfer: Record "Funds Transfer Header")
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::SwizzsoftApprovalsCodeUnit, 'FnOnSendInternalTransfersTransactionsForApproval', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::SwizzsoftApprovalsCodeUnit, 'FnOnCancelInternalTransfersTransactionsApprovalRequest', '', false, false)]
